				...
				<div class="main-row">
					<div class="12u-first">	
							...
							<table>
								...
								<tr>
									<td><h4>What payment types are accepted?</h4></td>
								</tr>
								<tr>
									<td>At the moment only check payment supported.</td>
								</tr>
								...
								<tr>
									<td><h4>Can I join as an Associate and become a Member at a later date?</h4></td>
								</tr>
								<tr>
