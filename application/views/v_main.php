				...
				<div class="12u-first">
					...
					<header id="header">
						...
						<nav>
							...
							<a href="twocolumn1.html">About GIN</a>
							<a href="twocolumn2.html">Join Now</a>
							<a href="onecolumn.html">FAQs</a>
							<a href="threecolumn.html">Contact Us</a>
							<a href="threecolumn.html">Website Login</a>
						</nav>
					</header>
				...
				<div class="main-row">
					<div class="4u-first">
						...
						<section>
							...
							<p>Hi! This is <strong>Minimaxing</strong>, a free design by <a href="http://nodethirtythree.com/">N33</a> for <a href="http://www.freecsstemplates.org/">FCT</a>.
							It's lightweight, built on HTML5 + CSS3 (using <a href="http://nodethirtythree.com/5grid/">5grid</a>), and fully responsive with
							support for wide, standard, and mobile displays. It's
							<a href="http://creativecommons.org/licenses/by/3.0/">CCA</a>-licensed so just
							keep the footer credit in place and you're good to go :)
							</p>
							<footer class="controls">
								<a href="http://nodethirtythree.com/" class="button">More cool designs ...</a>
							</footer>
						</section>
				...
				<div class="main-row">
					<div class="6u-first">
						...
						<section>
							...
							<ul class="big-image-list">
								<li>
									<a href="#"><img src="css/images/pic3.jpg" alt="" class="left" /></a>
								...
								<li>
									<a href="#"><img src="css/images/pic4.jpg" alt="" class="left" /></a>
									<h3>Magna Gravida Dolore</h3>
									<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo 
									facilisis amet quis consectetur in, sollicitudin vitae justo. Cras 
									Maecenas eu arcu purus, phasellus fermentum elit.</p>
								...
								<li>
									<a href="#"><img src="css/images/pic5.jpg" alt="" class="left" /></a>
									<h3>Magna Gravida Dolore</h3>
									<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo 
									facilisis amet quis consectetur in, sollicitudin vitae justo. Cras 
									Maecenas eu arcu purus, phasellus fermentum elit.</p>
					...
					<div class="6u">
						...
						<article class="blog-post">
							...
							<a href="#"><img src="css/images/pic6.jpg" alt="" class="top blog-post-image" /></a>
							<h3>Magna Gravida Dolore</h3>
